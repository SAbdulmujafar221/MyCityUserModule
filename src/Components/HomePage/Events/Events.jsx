...
const Carousel = () => {
  ...
  return (
    <div className="carousel-container">
      <h1 className="intro">Celebrations</h1>
      <div className="wrapping-events">
        <div className="intro-nav">
          <p className="introEvents">
            Mark the major events for your next visit.
          </p>
        </div>

        <div className="custom-navigation">
          <p className="prev-btn" onClick={() => swiperRef.current?.slidePrev()}>
            <FaArrowLeft />
          </p>
          <p className="next-btn" onClick={() => swiperRef.current?.slideNext()}>
            <FaArrowRight />
          </p>
        </div>
      </div>
